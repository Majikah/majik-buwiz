...
interface CBaseUserAccountProps {
  ...
  onBlock?: (data: MajikInvoiceContact) => void;
  onUnBlock?: (data: MajikInvoiceContact) => void;
  onUpdatePassphrase?: (params: PassphraseUpdateParams) => void;
  onRegister?: (data: MajikInvoiceContact) => void;
  onDownload?: (data: MajikInvoiceContact) => void;
  canEdit?: boolean;
  canDelete?: boolean;
  index?: number;
}
    ...
    <Card $isActive={isActiveAccount} onClick={handleOnPressed}>
      ...
      <CardHeader>
        <IdentityRow>
          ...
          <IdentityMeta>
            <AccountName $blocked={false} data-private>
              {displayName}
            </AccountName>
            <BadgeRow>
              {isActiveAccount && (
        ...
        {hasAnyAction && (
          <CardActions>
            ...
            {/* Edit metadata (open parent editor) */}
            {!!onEdit && (
              <StyledIconButton
                icon={PencilIcon}
                title="Edit"
