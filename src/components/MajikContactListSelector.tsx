...
interface MajikInvoiceContactListSelectorProps {
  id?: string;
...
export function MajikInvoiceContactListSelector({
  id,
  contacts,
  groups = [],
  value = [],
  ...
  compact = false,
  maxContacts,
}: MajikInvoiceContactListSelectorProps): JSX.Element {
  const isSingleMode = maxContacts === 1;

  const [list, setList] = useState<MajikInvoiceContact[]>(value);
...
export default MajikInvoiceContactListSelector;
