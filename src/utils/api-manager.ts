import { base64Decode, base64Encode, isSTXExpired, secureReverse, secureTimecode } from './utils'
...
export class APIKeyManager {
  ...
  private generateRootHash(stx: string): string {
    const appendedStrings = appendStrings([secureReverse(stx), this.API_KEY, stx, this.API_HASH])
   ...
   */
  private static validatePayload(payload: EncodedAPI, bypassSTXCheck = false): boolean {
